...
# Tên prompt — duy nhất trong Hub của bạn
PROMPT_V1_NAME = "nguyenthivang-rag-v1"
PROMPT_V2_NAME = "nguyenthivang-rag-v2"
...
SYSTEM_V1 = (
    ...
    "Giữ câu trả lời NGẮN GỌN và đi thẳng vào vấn đề (2-4 câu).\n"
    "Nếu context không chứa thông tin, hãy nói rõ là bạn không biết.\n\n"
    "Context:\n{context}"
)
...
# SYSTEM_V2 — phong cách có cấu trúc, giọng chuyên gia, 3-5 câu
SYSTEM_V2 = (
    "Bạn là một chuyên gia AI giàu kinh nghiệm. Hãy đọc kỹ context bên dưới, "
    "xác định các facts liên quan nhất, sau đó viết câu trả lời RÕ RÀNG và CÓ TỔ CHỨC.\n"
    "Trình bày đầy đủ ý chính, giải thích ngắn gọn lý do (3-5 câu).\n"
    "Chỉ dựa vào context — nếu context không đủ thông tin, hãy nêu rõ điều đó "
    "thay vì suy đoán.\n\n"
    "Context:\n{context}"
)
